...
<!DOCTYPE html>
      ...
      <body class="bg-neutral-900 text-white font-sans flex justify-center items-center h-screen">
        <div class="text-center"> 
          <h1 class="text-5xl font-extrabold text-yellow-400 mb-4">Welcome to EkiliSync Backend</h1>
          <p class="text-lg text-neutral-300">The backend of EkiliSync is up and running smoothly.</p>
          <p class="mt-4 text-md text-neutral-500">Powered by NestJS</p>
          <div class="mt-8">
